...
(function($) {
	...
	$.csv2table={
		...
		loadImg  : (new Image()).src='../economia/js/img/ajax-loader.gif',  //Dafault loading IMG 
		sortNImg : (new Image()).src='../economia/js/img/icon-n.gif',         //Dafault sort IMG N
		sortDImg : (new Image()).src='../economia/js/img/icon-d-green.gif',   //Dafault sort IMG D 
		sortAImg : (new Image()).src='../economia/js/img/icon-a-green.gif',   //Dafault sort IMG A
		setting  : [],
		data     : [],
		_rowsAry : [],
		_doc     : document,
	...
	$.fn.csv2table= function (url,setting){ 
		...
		if(typeof url==='string' && !setting )setting={url:url}
		else if(typeof url==='string' && typeof setting==='object')$.extend(setting,{url:url})
		else if(typeof url==='object')setting=url;
		...
		op = $.csv2table.setting[id] = $.extend({
			...
			nowloadingMsg      : '',                 //Massege of  now loading...
		...
		$.get(op.url+"?"+(new Date()).getTime(),"",function(data,textStatus){
